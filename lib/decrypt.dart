...
class DecryptPage extends StatefulWidget {
  DecryptPage({Key key, this.title}) : super(key: key);
...
class _DecryptPageState extends State<DecryptPage> {
  final ctrllr = new TextEditingController();
    ...
    String message = "This is your old message. Hold to copy;";
    _appBar(){
              ...
              children: <Widget>[
                new RaisedButton(
                  ...
                  new RaisedButton(
                    ...
                    textColor: Colors.black,
                    color: Colors.yellow,
                    onPressed: (){_resetMessage(Cipher().medCipherDecrypt(ctrllrKey.text, ctrllr.text));},
                  ...
                  new RaisedButton(
                    ...
                    textColor: Colors.black,
                    color: Colors.red,
                    onPressed: (){_resetMessage(Cipher().hardCipherDecrypt(ctrllr.text));},
                    child: new Text("Hard"),
                  ),
            ],),]),
            new Column(
